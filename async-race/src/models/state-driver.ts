...
export class StateDriver {
  ...
  setState(identifer: string, values: StateObject) {
    ...
    // StateDriver.states[identifer] = { ...values };
    StateDriver.stateInteractor = { identifer, values };
  }
